...
class ReportDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        title.setStyleSheet("font-size: 24px; font-weight: bold; color: #FFD6E0;")
        layout.addWidget(title)

        # Subtitle
        subtitle = QLabel("Found a bug or have an idea? Let us know and we'll improve Cygnus in future updates.")
        subtitle.setStyleSheet("font-size: 13px; color: #CBAACD;")
        ...
        title_label.setStyleSheet("font-size: 13px; color: #FFD6E0; font-weight: 500;")
        ...
        desc_label.setStyleSheet("font-size: 13px; color: #FFD6E0; font-weight: 500;")
