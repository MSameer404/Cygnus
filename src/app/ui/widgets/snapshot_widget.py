...
class SnapshotWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        # LEFT: Profile Card
        profile_card = QFrame()
        profile_card.setStyleSheet("background-color: #2A2C31; border-radius: 12px;")
        ...
        name_lbl.setStyleSheet("font-size: 20px; font-weight: bold; color: #F5F1E8;")
        ...
        if details:
            ...
            details_lbl.setStyleSheet("font-size: 14px; color: #A8A29E;")
        ...
        date_time_card.setStyleSheet("background-color: #2A2C31; border-radius: 12px;")
        ...
        date_lbl.setStyleSheet("font-size: 18px; color: #A8A29E;")
        ...
        subjects_card.setStyleSheet("background-color: #2A2C31; border-radius: 12px;")
        ...
        sub_title.setStyleSheet("font-size: 18px; font-weight: bold; color: #F5F1E8; margin-bottom: 5px;")
        ...
        if not breakdown:
            ...
            if isinstance(breakdown, dict):
                for name, item in breakdown.items():
                    ...
                    name_lbl.setStyleSheet("font-size: 15px; color: #F5F1E8;")
        ...
        # RIGHT: Today's Tasks
        tasks_card = QFrame()
        tasks_card.setStyleSheet("background-color: #2A2C31; border-radius: 12px;")
        ...
        task_title.setStyleSheet("font-size: 18px; font-weight: bold; color: #F5F1E8; margin-bottom: 5px;")
        ...
        if not tasks:
            ...
            for t in tasks:
                ...
                t_style = "font-size: 14px; text-decoration: line-through; color: #7A819E;" if is_comp else "font-size: 14px; color: #F5F1E8;"
