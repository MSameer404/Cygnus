...
class WeekReportDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        header = QLabel(
            f"<h2>Week Report</h2>"
            f"<p style='color: #6EE7B7; font-size: 14px;'>"
        ...
        chart_title.setStyleSheet("font-weight: bold; font-size: 14px; color: #ECFDF5;")
        ...
        best_title.setStyleSheet("color: #6EE7B7; font-size: 12px;")
        ...
        avg_title.setStyleSheet("color: #6EE7B7; font-size: 12px;")
        ...
        days_title.setStyleSheet("color: #6EE7B7; font-size: 12px;")
