...
class SubjectCard(QFrame):
    ...
    def _setup_ui(self):
        ...
        name_label.setStyleSheet("font-weight: 600; font-size: 14px; color: #FFD6E0; letter-spacing: 0.3px;")
        content_layout.addWidget(name_label)

        # Today's study time
        time_label = QLabel(self._today_time_text)
        time_label.setProperty("class", "subject-card-time")
        time_label.setStyleSheet("font-size: 11px; color: #CBAACD; font-weight: 500;")
